...
static int toSwallow = 1; // 1 mean swallow 0 mean not swallow
...
static const char *dmenucmd[] = { 
	"/home/white/.config/rofi/launchers/type-4/./launcher.sh", 
	NULL,
};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,  XK_q,      quit,           {0}                }, // needs to be last
	TAGKEYS( XK_1, 0 )
	TAGKEYS( XK_2, 1 )
	TAGKEYS( XK_3, 2 )
	TAGKEYS( XK_4, 3 )
