...
void bartabdraw(Monitor *m, Client *c, int unused, int x, int w, int groupactive) {
	if (!c) return;
...
void battabclick(Monitor *m, Client *c, int passx, int x, int w, int unused) {
...
void bartabcalculate(
	Monitor *m, int offx, int sw, int passx,
	void(*tabfn)(Monitor *, Client *, int, int, int, int)
) {
	Client *c;
	int 		i, clientsnmaster = 0, clientsnstack = 0, clientsnfloating = 0,
